...
<head>  
  <meta charset="utf-8" />
  <title>VDMS :: Add oppurtunity</title>
...
<body class="">
    ...
    <header class="bg-white header header-md navbar navbar-fixed-top-xs box-shadow">
      <div class="navbar-header aside-md dk">
        ...
        <a href="index.php" class="navbar-brand">
          <img src="images/logo.PNG"  alt="scale" height="100" width="50">
				...
				<div class="modal-dialog" style="width:500px;">
					<div class="modal-content">
						...
						<div class="modal-body" style='font-size:14px'>
							You have successfully added a new oppurtunity click the <b>OK</b> button to go to the oppurtunity page
						</div>
  ...
  <script>
	$('#opp_form').submit(function(e){
		...
		var loca = $('#loca').val();
		var type = $('#type').val();
		if(opp_name=="" || intro=="" || req=="" || loca=="" || type=="")
		{
			if(opp_name=="")
			{
				$('#opp_name_msg').html("Oppurtunity name is required");
			}
			if(intro=="")
			{
				$('#intro_msg').html("An introduction or briefing is required");
			}			
			if(req=="")
			{
				$('#requirements_msg').html("Please state your requirements");
			}			
			if(loca=="")
			{
				$('#loca_msg').html("A location is required");
			}			
			if(type=="")
			{
				$('#type_msg').html("Oppurtunity type is required");
			}
		}
		else
		{
				$.ajax({
					url:"handler/add_new_opp.php",
					type:"POST",

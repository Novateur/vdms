...
<?php echo "<body onload=\"get_all_app()\">"; ?>
  <section class="vbox">
            ...
            <section>
              <section class="vbox">
                <section class="scrollable padder"><br/>              
					<div class="col-sm-12">
                      <div class="alert alert-success"><h2 class="m-b-xs text-black"><i class="i i-folder2 "></i> Applications</h2></div>
  ...
  <script>
	...
	{
		$.get("handler/get_all_app.php",function(response){
			$('#paste_app').html(response);
			//alert(response);
		})
	}
  </script>

                        ...
                        <li class="active">
                          <a href="new_vendor.php" class="auto">                                                        
							...
							<ul class="nav dk" >
								...
								<li class="active">
									<a href="new_vendor_in.php" class="auto">                                                        
										<i class="i i-dot"></i>
				...
				<div class="modal-dialog" style="width:500px;">
					<div class="modal-content">
						...
						<div class="modal-body" style='font-size:14px'>
							You have successfully added a new vendor to your system click the <b>OK</b> button to proceed
						</div>
						<div class="modal-footer">
							<a href='vendors.php' data-role='button' class="btn btn-success">OK</a>
						</div>
					</div>
				</div>
			</div>
  ...
  <script>
	$('#vendor_form').submit(function(e){
		...
		if(first_name=="" || last_name=="" || country=="")
		{
			if(first_name=="")
			{
				$('#first_name_msg').html("Your first name is required");
			}			
			if(last_name=="")
			{
				$('#last_name_msg').html("Your last name is required");
			}
			if(country=="")
			{
		...
		{
				$.ajax({
					url:"handler/register_vendor2.php",
					type:"POST",

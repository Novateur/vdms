      ...
      <section class="hbox stretch">
        ...
        <section id="content">
          <section class="hbox stretch">
            <section>
              <section class="vbox">
                <section class="scrollable padder" id="paste_fetched">              
                  <section class="row m-b-md">
                    <div class="col-sm-6">
                      <h2 class="m-b-xs text-black">Dashboard</h2>
                      <h4>Welcome back, <?php echo get_user_name(); ?>, <i class="fa fa-map-marker fa-lg text-primary"></i> <?php echo get_user_location(); ?></h4>
                    </div>
                      ...
                      <div class="panel b-a">
                        <div class="row m-n">
                          <div class="col-md-6 b-b b-r">
                            <a href="index.php" class="block padder-v hover">
                              <span class="i-s i-s-2x pull-left m-r-sm">
                                <i class="i i-hexagon2 i-s-base text-danger hover-rotate"></i>
                                <i class="i i-home i-1x text-white"></i>
                              </span>
                              <span class="clear">
                                <span class="h3 block m-t-xs text-danger">Home</span>
                                <small class="text-muted text-u-c" style="margin-top:50px">Find your way from here</small>
                              </span>
                            </a>
                          </div>
                          <div class="col-md-6 b-b">
                            <a href="vendors.php" class="block padder-v hover">
                              <span class="i-s i-s-2x pull-left m-r-sm">
                                <i class="i i-hexagon2 i-s-base text-success-lt hover-rotate"></i>
                                <i class="i i-users3 i-sm text-white"></i>
                              </span>
                              <span class="clear">
                                <span class="h3 block m-t-xs text-success">Vendors</span>
                                <small class="text-muted text-u-c">Manage and add new business vendors</small>
                              </span>
                            </a>
                          </div>
                          <div class="col-md-6 b-b b-r">
                            <a href="oppurtunity.php" class="block padder-v hover">
                              <span class="i-s i-s-2x pull-left m-r-sm">
                                <i class="i i-hexagon2 i-s-base text-info hover-rotate"></i>
                                <i class="i i-grid2 i-sm text-white"></i>
                              </span>
                              <span class="clear">
                                <span class="h3 block m-t-xs text-info">Oppurtunity</span>
                                <small class="text-muted text-u-c">Manage and add new tender oppurtunities</small>
                              </span>
                            </a>
                          </div>
                          <div class="col-md-6 b-b">
                            <a href="contracts.php" class="block padder-v hover">
                              <span class="i-s i-s-2x pull-left m-r-sm">
                                <i class="i i-hexagon2 i-s-base text-warning hover-rotate"></i>
                                <i class="fa fa-suitcase i-sm text-white"></i>
                              </span>
                              <span class="clear">
                                <span class="h3 block m-t-xs text-primary">Contracts</span>
                                <small class="text-muted text-u-c">Manage and follow up your contracts</small>
                              </span>
                            </a>
                          </div>                          
						  <div class="col-md-6 b-b b-r">
                            <a href="applications.php" class="block padder-v hover">
                              <span class="i-s i-s-2x pull-left m-r-sm">
                                <i class="i i-hexagon2 i-s-base text-default hover-rotate"></i>
                                <i class="i i-folder2 i-sm text-white"></i>
                              </span>
                              <span class="clear">
                                <span class="h3 block m-t-xs text-info">Applications</span>
                                <small class="text-muted text-u-c">Manage and organize all tender applications</small>
                              </span>
                            </a>
                          </div>
                          <div class="col-md-6 b-b">
                            <a href="settings.php" class="block padder-v hover">
                              <span class="i-s i-s-2x pull-left m-r-sm">
                                <i class="i i-hexagon2 i-s-base text-primary hover-rotate"></i>
                                <i class="i i-cog2 i-sm text-white"></i>
                              </span>
                              <span class="clear">
                                <span class="h3 block m-t-xs text-primary">Settings</span>
                                <small class="text-muted text-u-c">Manage your vdms account</small>
                              </span>
                            </a>
                          </div>
                        </div>

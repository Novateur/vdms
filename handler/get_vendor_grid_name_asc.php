<?php
	...
	$sql = "SELECT * FROM vendors WHERE company_id={$id} ORDER BY name ASC LIMIT $start, $limit";
						...
						<div class='col-xs-12 b-r'>
							<p class='text-muted pull-right dropdown-toggle' data-toggle='dropdown' style='margin-top:-10px'><a href='#'><i class='i i-bars3'></i></a>
								<ul class='dropdown-menu pull-right'>
								  <li><a href='#' onclick=\"del_vendor({$r['id']},'grid','name_grid_asc',{$page})\"><i class='i i-trashcan'></i> Delete</a></li>
								</ul>
							</p>
						</div>
					</div>

<?php
	...
	if(isset($_GET['user_ref']) && !empty($_GET['user_ref']))
	{ 
		if(get_comp_id_user()==$_GET['user_ref'])
		{
			$comp_id = $_GET['user_ref'];
		}
		else
		{
...
<head>  
  <meta charset="utf-8" />
  <title>VDMS :: Contract details</title>
							...
							<div class="panel panel-default">
								...
								<header class='panel-heading font-bold' style='padding:30px'>
									<div class='form-group' style='margin-top:-10px;float:right'>
										...
										<?php echo "<a href='contracts.php?page={$page}' data-role='button' class='btn btn-success'>Back</a>";?>
									</div>
							</div>
						</header>
							</div>
